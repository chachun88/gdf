                    ...
                    if "error" in res:
                        ...
                        if username != '':
                            try:
                                ...
                                mensaje.add_to(['yichun212@gmail.com','julian@loadingplay.com','contacto@gianidafirenze.cl'])
...
class PreviewHomeHandler(BaseHandler):
    ...
    def post(self):
        ...
        data["banner1_movil"] = self.jsonToObject(self.get_argument("banner1_movil", ""))
        data["banner2_movil"] = self.jsonToObject(self.get_argument("banner2_movil", ""))
        data["banner3_movil"] = self.jsonToObject(self.get_argument("banner3_movil", ""))
        data["caluga_video"] = self.jsonToObject(self.get_argument("caluga_video", ""))
