    ...
    def post(self):
        ...
        try:
            ...
            if len(lista) > 0:
                ...
                """.format(order_id=order.id,name=facturacion["name"].encode('ascii', 'xmlcharrefreplace'),address=facturacion["address"].encode('ascii', 'xmlcharrefreplace'),town="",city=facturacion["city"].encode('ascii', 'xmlcharrefreplace'),country="",telephone=facturacion["telephone"],email=facturacion["email"])
                ...
                """.format(order_id=order.id,name=despacho["name"].encode('ascii', 'xmlcharrefreplace'),address=despacho["address"].encode('ascii', 'xmlcharrefreplace'),town="",city=despacho["city"].encode('ascii', 'xmlcharrefreplace'),country="",telephone=despacho["telephone"],email=despacho["email"])
