        ...
        if len(lista) > 0:
            ...
            if len(lista) > 0:
                ...
                if "success" in response_obj:
                    ...
                    """.format(order_id=order.id,name=facturacion["name"],address=facturacion["address"].encode("utf-8"),town="",city=facturacion["city"],country="",telephone=facturacion["telephone"],email=facturacion["email"])
